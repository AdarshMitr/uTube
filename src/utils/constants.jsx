...
export const logo ='https://i.ibb.co/RzCG8BY/ut-logo.png';


export const categories = [
  { id:1, name: 'New', icon: <HomeIcon />, },
  { id:2, name: 'Learn JS', icon: <CodeIcon />, },
...
export const demoThumbnailUrl = '../img/adarshmitr.png';
export const demoChannelUrl = '/channel/#';
export const demoVideoUrl = '/video/#';
export const demoChannelTitle = 'Learn JavaScript ';
export const demoVideoTitle = 'Learn JavaScript & with API Projects in 8 Hours - Full Course Free';
